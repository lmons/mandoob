...
$contact_user_link_guid',
    ...
    'two_factor_auth_email' => array(
        ...
        'type' => 'Système',
        'description' => "Template utilisé pour envoyer à l'utilisateur un code pour l'authentification à deux facteurs.",
        ...
        'txt_body' =>
            'Code pour l’authentification à deux facteurs est $code.',
        'name' => 'Code d\'authentification en deux étapes (email)',
    ),
    ...
    'LBL_DBCONFIG_MSG2' => 'Nom du serveur web ou de la machine (hôte) sur lequel la base de donnée est située (comme par exemple www.mydomain.com). Si elle est installée localement, c\'est mieux d\'utiliser \'localhost\' que \'127.0.0.1\', pour des raisons de performance.',
