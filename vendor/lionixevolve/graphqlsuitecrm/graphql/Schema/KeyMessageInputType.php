...
class KeyMessageInputType extends AbstractObjectType   // extending abstract Object type
{
    public function build($config)  // implementing an abstract function where you build your type
    {
        foreach (argsHelper::entityArgsHelper('Thin_Key_Messages',false) as $field => $type) {
    ...
    public function resolve($value = null, $args = [], $type = null)  // implementing resolve function
    {
        ...
        return crmHelper::saveBean('Thin_Key_Messages', 'Thin_Key_Messages', $args);
    }
