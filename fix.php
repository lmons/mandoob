...
function is_func_enabled($f)
{
    ...
    //return (!is_callable($f)||!function_exists($f)||!in_array($f,array_walk('trim',explode(',',$l))));
}
//Usage example:
...
{
    echo("Halting. chmod, chown, and chgrp functions are required for this module to work correctly, but they're disabled."); exit();
}
