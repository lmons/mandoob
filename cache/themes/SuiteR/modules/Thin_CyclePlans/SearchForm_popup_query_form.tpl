...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Thin_CyclePlans'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='Thin_CyclePlans'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='cp_type_c_advanced'>{sugar_translate label='LBL_CP_TYPE' module='Thin_CyclePlans'}</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='cp_type_c_advanced' name='cp_type_c_advanced[]' options=$fields.cp_type_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.cp_type_c_advanced.value}
   	   	</td>
	</tr>
<tr>
	<td colspan='20'>
