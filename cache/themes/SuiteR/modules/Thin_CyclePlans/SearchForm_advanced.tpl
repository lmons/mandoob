...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.assigned_user_id_advanced.value}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='start_date_advanced'>{sugar_translate label='LBL_START_DATE' module='Thin_CyclePlans'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='active_advanced'>{sugar_translate label='LBL_ACTIVE' module='Thin_CyclePlans'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
{if strval($fields.active_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.active_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.active_advanced.name}" name="{$fields.active_advanced.name}"   >
