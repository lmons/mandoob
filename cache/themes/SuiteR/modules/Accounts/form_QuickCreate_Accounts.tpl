...
addToValidate('form_QuickCreate_Accounts', 'date_entered_date', 'date', false,'Date de création ' );
addToValidate('form_QuickCreate_Accounts', 'date_modified_date', 'date', false,'Date de modification ' );
...
addToValidate('form_QuickCreate_Accounts', 'city_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_CITY' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'account_subtype_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_SUBTYPE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'acc_number_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_ACC_NUMBER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'brick_c', 'varchar', true,'{/literal}{sugar_translate label='LBL_BRICK' module='Accounts' for_js=true}{literal}' );
