...
<input type='text' name='{$fields.city_c_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='brick_c_advanced'>{sugar_translate label='LBL_BRICK' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.brick_c_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='address_c_advanced'>{sugar_translate label='LBL_ADDRESS' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.address_c_advanced.value) <= 0}
{assign var="value" value=$fields.address_c_advanced.default_value }
{else}
{assign var="value" value=$fields.address_c_advanced.value }
{/if}  
<input type='text' name='{$fields.address_c_advanced.name}' 
    id='{$fields.address_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='specialty_c_advanced'>{sugar_translate label='LBL_SPECIALTY' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='specialty_c_advanced' name='specialty_c_advanced[]' options=$fields.specialty_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.specialty_c_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='prc_number_c_advanced'>{sugar_translate label='LBL_PRC_NUMBER' module='Contacts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{if strlen($fields.prc_number_c_advanced.value) <= 0}
{assign var="value" value=$fields.prc_number_c_advanced.default_value }
{else}
{assign var="value" value=$fields.prc_number_c_advanced.value }
{/if}  
<input type='text' name='{$fields.prc_number_c_advanced.name}' 
    id='{$fields.prc_number_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
   	   	</td>
	</tr>
