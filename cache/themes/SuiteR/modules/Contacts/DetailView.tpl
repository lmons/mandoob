...
{if is_string($fields.specialty_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.specialty_c.name}" value="{ $fields.specialty_c.options }">
{ $fields.specialty_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.specialty_c.name}" value="{ $fields.specialty_c.value }">
{ $fields.specialty_c.options[$fields.specialty_c.value]}
{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TYPE' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{/if} 
<span class="sugar_field" id="{$fields.address_c.name}">{$fields.address_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_BRICK' module='Contacts'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{/if} 
<span class="sugar_field" id="{$fields.prc_number_c.name}">{$fields.prc_number_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
