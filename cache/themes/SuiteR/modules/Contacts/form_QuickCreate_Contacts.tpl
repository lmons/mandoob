...
addToValidate('form_QuickCreate_Contacts', 'city_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CITY' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'kol_c', 'bool', false,'{/literal}{sugar_translate label='LBL_KOL' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'prc_number_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_PRC_NUMBER' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'address_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADDRESS' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'specialty_c', 'enum', true,'{/literal}{sugar_translate label='LBL_SPECIALTY' module='Contacts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Contacts', 'brick_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BRICK' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'kol_type_c', 'enum', false,'{/literal}{sugar_translate label='LBL_KOL_TYPE' module='Contacts' for_js=true}{literal}' );
