...
addToValidate('EditView', 'dash_dashboardmanager_users_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dash_dashboardmanager_users_2_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_2_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'dash_dashboardmanager_users_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_DASH_DASHBOARDMANAGER_USERS_1_FROM_DASH_DASHBOARDMANAGER_TITLE' module='Users' for_js=true}{literal}' );
...
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_reports_to_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name","reports_to_id"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};</script>{/literal}
