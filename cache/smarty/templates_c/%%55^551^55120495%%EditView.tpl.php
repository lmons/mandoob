<?php /* Smarty version 2.6.29, created on 2019-05-20 10:00:24
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=Fd6Vg5BlLsskkVxr-Ge2nw'></script>
...
<?php echo '\' );
addToValidate(\'EditView\', \'pwd_last_changed_date\', \'date\', false,\'Dernier changement du Mot de passe\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', true,\'Date de création\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', true,\'Date de modification\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'dash_dashboardmanager_users_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'dash_dashboardmanager_users_2_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_2_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'dash_dashboardmanager_users_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DASH_DASHBOARDMANAGER_USERS_1_FROM_DASH_DASHBOARDMANAGER_TITLE','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_reports_to_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["reports_to_name","reports_to_id"],"required_list":["reports_to_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};</script>'; ?>
