<?php /* Smarty version 2.6.29, created on 2019-05-20 10:58:36
         compiled from custom/modules/Calls/tpls/additionalDetails.caption.tpl */ ?>
...
" class="btn btn-xs"><span class="glyphicon glyphicon-eye-open"></span></a><?php endif; ?>
        <?php if ($this->_tpl_vars['ACL_DETAIL_VIEW'] == true && $this->_tpl_vars['FIELD']['STATUS'] != 'Held'): ?><a href="index.php?action=EditView&module=<?php echo $this->_tpl_vars['MODULE_NAME']; ?>
&record=<?php echo $this->_tpl_vars['FIELD']['ID']; ?>
