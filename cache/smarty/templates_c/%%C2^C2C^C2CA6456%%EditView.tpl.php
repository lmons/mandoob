<?php /* Smarty version 2.6.29, created on 2019-06-04 13:03:01
         compiled from cache/themes/SuiteR/modules/Calls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 48, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 58, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 76, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 185, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 287, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 53, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 59, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 62, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 65, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 85, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 1249, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Calls/EditView.tpl', 1257, false),)), $this); ?>
...
<input type="hidden" name="key-messages-reaction" id="key-messages-reaction" value="">   
<input type="hidden" name="current_module" id="current_module" value="<?php echo $_REQUEST['module']; ?>
">   
<input type="hidden" name="call_location_id" id="call_location_id" value="<?php echo $this->_tpl_vars['call_location_id']; ?>
">   
<input type="hidden" name="call_location_id_c" id="call_location_id_c" value="">   
...
" class="button primary" onclick="document.getElementById('status').disabled = false;document.getElementById('status').value='Planned';document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value='';  <?php endif; ?> if(check_form('EditView')) document.EditView.submit();" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"/> <input title="Submit" id="SUBMIT_HEADER" class="button primary" onclick="document.getElementById('status').disabled = false;document.getElementById('status').value='Held';document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value='';  <?php endif; ?> if(check_form('EditView')) document.EditView.submit();" type="button" name="button" value="Submit"/> <?php if (! empty ( $_REQUEST['return_action'] ) && ( $_REQUEST['return_action'] == 'DetailView' && ! empty ( $_REQUEST['return_id'] ) )): ?><input title="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_TITLE']; ?>
...
<select name='parent_type' tabindex="0" id='parent_type' title=''   accesskey='7' onchange='document.<?php echo $this->_tpl_vars['form_name']; ?>
...
<?php else: ?>Accounts<?php endif; ?><?php echo '"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};</script>
<script>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='call_location_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_LOCATION','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['call_location_c']['value'] ) && $this->_tpl_vars['fields']['call_location_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['call_location_c']['options'],'selected' => $this->_tpl_vars['fields']['call_location_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['call_location_c']['options'],'selected' => $this->_tpl_vars['fields']['call_location_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['call_location_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['call_location_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['call_location_c']['name']; ?>
');
...
<?php endif; ?>
<td valign="top" id='call_type_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_TYPE','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
" 
title=''        onChange="showHideAccompanying()"
>
<?php if (isset ( $this->_tpl_vars['fields']['call_type_c']['value'] ) && $this->_tpl_vars['fields']['call_type_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['call_type_c']['options'],'selected' => $this->_tpl_vars['fields']['call_type_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['call_type_c']['options'],'selected' => $this->_tpl_vars['fields']['call_type_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['call_type_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['call_type_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
" 
title=''           onChange="showHideAccompanying()"
...
id="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['call_type_c']['name']; ?>
');
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='<input type="hidden" name="adjust_view">_label' width='12.5%' data-total-columns="2" scope="col">
&nbsp;
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td valign="top" width='37.5%' data-total-columns="2" >
<td valign="top" id='accompanying_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOMPANYING','module' => 'Calls'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['accompanying_c']['value']; ?>
" title='' autocomplete="off" READONLY 	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['accompanying_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['accompanying_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['user_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_SELECT_USERS_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['accompanying_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"user_id_c","name":"accompanying_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_USERS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['accompanying_c']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['accompanying_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "custom/modules/Calls/tpls/productOrder.tpl", 'smarty_include_vars' => array()));
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "custom/modules/Calls/tpls/products.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</tr>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL2','module' => 'Calls'), $this);?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "custom/modules/Calls/tpls/samples.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</tr>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL3','module' => 'Calls'), $this);?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "custom/modules/Calls/tpls/keyMessages.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</tr>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'CONATCTS','module' => 'Calls'), $this);?>

<script>
      document.getElementById('detailpanel_5').className += ' expanded';
    </script>
</h4>
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='CONATCTS'  class="yui3-skin-sam edit view panelContainer">
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "custom/modules/Calls/tpls/contactsInAccount.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</tr>
...
<?php if ($this->_tpl_vars['panelFieldCount'] == 0): ?>
<script>document.getElementById("CONATCTS").style.display='none';</script>
<?php endif; ?>
</div></div>
...
" class="button primary" onclick="document.getElementById('status').disabled = false;document.getElementById('status').value='Planned';document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value='';  <?php endif; ?> if(check_form('EditView')) document.EditView.submit();" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
"/>
<input title="Submit" id="SUBMIT_HEADER" class="button primary" onclick="document.getElementById('status').disabled = false;document.getElementById('status').value='Held';document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value='';  <?php endif; ?> if(check_form('EditView')) document.EditView.submit();" type="button" name="button" value="Submit"/>
...
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date création \' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date modification \' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'date_start_date\', \'date\', true,\'Date début \' );
addToValidate(\'EditView\', \'date_end_date\', \'date\', false,\'Date fin \' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'call_type_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_TYPE','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'accompanying_c\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOMPANYING','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'call_location_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_LOCATION','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'user_id_c\', \'id\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOMPANYING_USER_ID','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'call_location_name_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CALL_LOCATION_NAME','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\' );
...
addToValidateBinaryDependency(\'EditView\', \'accompanying_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Calls','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCOMPANYING','module' => 'Calls','for_js' => true), $this);?>
<?php echo '\', \'user_id_c\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_parent_name\']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'EditView_accompanying_c\']={"form":"EditView","method":"query","modules":["Users"],"group":"or","field_list":["name","id"],"populate_list":["accompanying_c","user_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Pas de correspondance"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Pas de correspondance"};</script>'; ?>
