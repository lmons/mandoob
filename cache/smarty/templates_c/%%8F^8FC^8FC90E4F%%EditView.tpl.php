<?php /* Smarty version 2.6.29, created on 2019-05-30 12:37:27
         compiled from cache/themes/SuiteR/modules/Meetings/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 40, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 54, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 72, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 111, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 213, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 55, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 58, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 61, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 86, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 610, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Meetings/EditView.tpl', 618, false),)), $this); ?>
...
" class="button primary" onclick="/*SUGAR.meetings.fill_invitees();*/document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if (isset ( $_REQUEST['isDuplicate'] ) && $_REQUEST['isDuplicate'] == 'true'): ?>document.EditView.return_id.value=''; <?php endif; ?> if(check_form('EditView')) document.EditView.submit();" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_SAVE_BUTTON_LABEL']; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='tm_type_c_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TM_TYPE','module' => 'Meetings'), $this);?>
...
<select name="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
" 
title=''      accesskey='7'   
>
<?php if (isset ( $this->_tpl_vars['fields']['tm_type_c']['value'] ) && $this->_tpl_vars['fields']['tm_type_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['tm_type_c']['options'],'selected' => $this->_tpl_vars['fields']['tm_type_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['tm_type_c']['options'],'selected' => $this->_tpl_vars['fields']['tm_type_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['tm_type_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['tm_type_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
" 
title=''          accesskey='7'  
...
id="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['tm_type_c']['name']; ?>
');
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='date_start_label' width='12.5%' data-total-columns="1" scope="col">
...
<?php echo '\' );
addToValidate(\'EditView\', \'date_start_date\', \'date\', true,\'Date de début \' );
...
<?php echo '\', \'date_end\' );
addToValidate(\'EditView\', \'date_end_date\', \'date\', false,\'Date de fin\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'tm_type_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TM_TYPE','module' => 'Meetings','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'tm_accept_decline\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TM_ACCEPT_DECLINE','module' => 'Meetings','for_js' => true), $this);?>
<?php echo '\' );
