...
">
						...
						<div class="panel panel-default ">
							...
							<div id="subpanel_settings_color" class="panel-body panel-collapse collapse in">
								<table class="table-responsive">
									<tr>
										<th><?php echo $this->_tpl_vars['MOD']['LBL_MODULE']; ?>
</th><th><?php echo $this->_tpl_vars['MOD']['LBL_BODY']; ?>
</th><th><?php echo $this->_tpl_vars['MOD']['LBL_BORDER']; ?>
</th><th><?php echo $this->_tpl_vars['MOD']['LBL_TEXT']; ?>
</th>
									</tr>
