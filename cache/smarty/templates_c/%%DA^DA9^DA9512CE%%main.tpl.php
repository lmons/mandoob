...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'custom/modules/Calendar/tpls/main.tpl', 217, false),array('function', 'sugar_getjspath', 'custom/modules/Calendar/tpls/main.tpl', 352, false),array('function', 'sugar_getscript', 'custom/modules/Calendar/tpls/main.tpl', 361, false),)), $this); ?>
...
<?php echo '"
		...
		YAHOO.util.Event.on("btn-submit","click",function(){
			document.getElementById(\'status\').disabled = false;
			document.getElementById(\'status\').value=\'Held\';
...
//            CAL.editDialog.cancel();
		...
		YAHOO.util.Event.on(CAL.get("btn-cancel-calls-meeting"), \'click\', function(){
			$(\'.modal-calls-meeting-detail\').modal(\'hide\');
		});
		'; ?>
...
<div class="modal fade modal-cal-edit" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer" id="calendar_buttons">
				<button id="btn-save" class="button" type="button" ><?php echo $this->_tpl_vars['MOD']['LBL_SAVE_BUTTON']; ?>
</button>
				<button id="btn-submit" class="button" type="button">réaliser</button>
				<button id="btn-cancel" class="button" type="button" data-dismiss="modal"><?php echo $this->_tpl_vars['MOD']['LBL_CANCEL_BUTTON']; ?>
</button>
				<button id="btn-delete" class="button" type="button" style="display:none;"><?php echo $this->_tpl_vars['MOD']['LBL_DELETE_BUTTON']; ?>
</button>
				<button id="btn-send-invites" class="button" type="button" style="display:none;"><?php echo $this->_tpl_vars['MOD']['LBL_SEND_INVITES']; ?>
</button>
				<button id="btn-full-form" class="button" type="button" fie=<?php echo $this->_tpl_vars['status']; ?>
...
<div class="modal fade modal-calls-meeting-detail" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
			...
			<div class="modal-footer">
				<button id="btn-cancel-calls-meeting" class="button" type="button"><?php echo $this->_tpl_vars['MOD']['LBL_CANCEL_BUTTON']; ?>
</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
...
<?php echo smarty_function_sugar_getscript(array('file' => "custom/modules/Calendar/Cal.js"), $this);?>
