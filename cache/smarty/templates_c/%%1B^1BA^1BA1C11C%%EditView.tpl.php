<?php /* Smarty version 2.6.29, created on 2019-05-20 10:31:53
         compiled from cache/themes/SuiteR/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 43, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 53, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 77, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 234, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 336, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 48, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 54, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 57, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 60, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 109, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Contacts/EditView.tpl', 541, false),)), $this); ?>
...
<td valign="top" id='primary_address_city_label' width='12.5%' data-total-columns="2" scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRIMARY_ADDRESS_CITY','module' => 'Contacts'), $this);?>
...
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='specialty_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<select name="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['specialty_c']['value'] ) && $this->_tpl_vars['fields']['specialty_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['specialty_c']['options'],'selected' => $this->_tpl_vars['fields']['specialty_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['specialty_c']['options'],'selected' => $this->_tpl_vars['fields']['specialty_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['specialty_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['specialty_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['specialty_c']['name']; ?>
');
...
<script type="text/javascript"
        src='<?php echo smarty_function_sugar_getjspath(array('file' => "include/SugarFields/Fields/Address/SugarFieldAddress.js"), $this);?>
'></script>
...
<td width="*">
<textarea id="primary_address_street" name="primary_address_street" maxlength="150"
                          rows="2" cols="30"
...
<td>
<input type="text" name="primary_address_city" id="primary_address_city" size="30"
...
<td>
<input type="text" name="primary_address_state" id="primary_address_state" size="30"
...
<td>
<input type="text" name="primary_address_postalcode" id="primary_address_postalcode" size="30"
...
<td>
<input type="text" name="primary_address_country" id="primary_address_country" size="30"
...
<td width="*">
<textarea id="alt_address_street" name="alt_address_street" maxlength="150"
                          rows="2" cols="30"
...
<td>
<input type="text" name="alt_address_city" id="alt_address_city" size="30"
...
<td>
<input type="text" name="alt_address_state" id="alt_address_state" size="30"
...
<td>
<input type="text" name="alt_address_postalcode" id="alt_address_postalcode" size="30"
...
<td>
<input type="text" name="alt_address_country" id="alt_address_country" size="30"
...
<td valign="top" id='prc_number_c_label' width='12.5%' data-total-columns="2" scope="col">
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['prc_number_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['prc_number_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CITY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'kol_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_KOL','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'prc_number_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRC_NUMBER','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'address_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ADDRESS','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'specialty_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SPECIALTY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'type_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'brick_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_BRICK','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'kol_type_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_KOL_TYPE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
