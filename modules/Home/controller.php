...
class HomeController extends SugarController{
    ...
    public function action_getsamplesinfo()
    {
        //$bean = BeanFactory::getBean($_REQUEST['current_module'], $_REQUEST['record']);
        $this->view = 'getsamplesinfo';
        //$this->view_object_map['currentModule']=$_REQUEST['current_module'];
        //$this->view_object_map['currentBean']=$bean;

    }
    public function action_sampleslotinfo()
    {
        $bean = BeanFactory::getBean($_REQUEST['current_module'], $_REQUEST['record']);
        $this->view = 'sampleslotinfo';
        $this->view_object_map['currentModule']=$_REQUEST['current_module'];
        $this->view_object_map['currentBean']=$bean;
