...
class HomeViewGetsamplesinfo extends SugarView
{
    public function display()
    {
        ...
        foreach ($current_user->get_linked_beans('aos_products_users_1','','name ASC') as $aProduct) {
            ...
            foreach ($aProduct->get_linked_beans('aos_products_aos_products_1','','name ASC') as $aSample) {
                $sampleParentProduct[]=$aSample->aos_products_aos_products_1aos_products_ida;
                $sampleName[]=$aSample->name;
                $sampleId[]=$aSample->id;
                $bd[$aSample->aos_products_aos_products_1_name][$aSample->id]=$aSample->name;
