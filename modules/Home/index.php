...
<script type='text/javascript' src='modules/Home/jspdf.js'></script>
<script>

$('#btnExport').click(function(e) {
 var divContents = $('#pageContainer').html();
...
$i = 0;
    while($i < count($pages)){
        if($i == 0){
            $pageTabs[$i]['pageTitle'] = $GLOBALS['app_strings']['LBL_SUITE_DASHBOARD_CSTM'];
