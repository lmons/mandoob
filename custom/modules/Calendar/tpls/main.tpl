	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer" id="calendar_buttons">
				...
				<button id="btn-delete" class="button" type="button" style="display:none;">{$MOD.LBL_DELETE_BUTTON}</button>
				<button id="btn-send-invites" class="button" type="button" style="display:none;">{$MOD.LBL_SEND_INVITES}</button>
				<button id="btn-full-form" class="button" type="button" fie={$status}>{$APP.LBL_FULL_FORM_BUTTON_LABEL}</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div>
...
<div class="modal fade modal-calls-meeting-detail" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button id="btn-cancel-calls-meeting" class="button" type="button">{$MOD.LBL_CANCEL_BUTTON}</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div>
