                ...
                console.log(id_contact)
                 YAHOO.util.Connect.asyncRequest('GET', 'API/ContactDefaultAccount.php?id_medecin=' + this.value, {
                    success: function (o) {
                        ...
                        document.getElementById('call_location_id_c').value="";
                    ...
                    success: function (o) {
                        ...
                        console.log(jsonResponse1);
                         var callLocationId = document.getElementById('call_location_id').value;
                        x.innerHTML = '';
                        jsonResponse1.entry_list.forEach(function (element, value) {
                           ...
                           else if(id_account!=="" && callLocationId=="" && id_account==element.name_value_list.id.value){
                               option.setAttribute('selected', 'selected');
                           }
                            x.add(option);
