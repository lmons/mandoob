<div id="qtip-6-title" class="qtip-title" aria-atomic="true">
    ...
    <div class="qtip-title-buttons">
        ...
        {if $ACL_DETAIL_VIEW == true && $FIELD.STATUS!='Held'}<a href="index.php?action=EditView&module={$MODULE_NAME}&record={$FIELD.ID}" class="btn btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>{/if}
    </div>
    {/if}
</div>