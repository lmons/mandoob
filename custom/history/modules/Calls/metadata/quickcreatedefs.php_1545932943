  ...
  array (
    ...
    array (
      ...
      array (
        ...
        1 => 
        array (
          'file' => 'custom/modules/Calls/getAccountNameQuickCreate.js',
        ),
          2 =>
              array (
          ...
          5 =>
              array (
                  'file' => 'custom/modules/Calls/showHideAccompanyingQuickCreate.js',
              ),
      ),
      'maxColumns' => '2',
      'form' => 
      array (
        ...
        array (
          ...
          4 => '<input type="hidden" name="contact_invitees">',
            5 => '<input type="hidden" name="current_module" id="current_module" value="{$smarty.request.module}">',
             6 => '<input type="hidden" name="contactInAccountFree" id="contactInAccountFree" value="">',
        ),
        'buttons' => 
        array (
          0 => 
          array (
            'customCode' => '<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="button" onclick=" alert(\'kjhkj\'); if(check_form(\'EditView\'))SUGAR.calls.fill_invitees();this.form.action.value=\'Save\'; this.form.return_action.value=\'DetailView\'; {if isset($smarty.request.isDuplicate) && $smarty.request.isDuplicate eq "true"}this.form.return_id.value=\'\'; {/if}return check_form(\'EditView\') && isValidDuration();" type="submit" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}">',
          ),
          2 =>
          array (
            'customCode' => '<input type="button" title="Submit" id="submit_call" onclick="SUGAR.calls.fill_invitees();this.form.action.value=\'SubmitCall\'; alert(\'ljk\'); document.EditView.return_action.value=\'DetailView\'; formSubmitCheck();;" class="button primary"  name="submit_call" value="Submit">',
          ),
          3 =>
          array (
